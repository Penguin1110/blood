  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative pt-12 pb-20 lg:pt-24 lg:pb-32 overflow-hidden px-4">
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-rose-200/50 rounded-full blur-3xl opacity-50 pointer-events-none" />
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-amber-200/50 rounded-full blur-3xl opacity-50 pointer-events-none" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-xl text-slate-600 mb-8 max-w-xl mx-auto lg:mx-0 font-medium">
                {user
                  ? `歡迎回來，${user.name}！隨時掌握自己的健康紀錄與捐血資格。`
            ...
            >
              ...
              >
                ...
                <div>
                  <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">加入我們</p>
                  <p className="text-lg font-extrabold text-slate-800">拯救更多生命</p>
                </div>
              </motion.div>
            </motion.div>
          </div>
