...
import { Heart, Menu, X, MapPin, Gift, User, Award } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
              ...
              <Link
                to="/profile"
                className="flex items-center gap-2 bg-amber-100/80 text-amber-700 px-4 py-2 rounded-2xl font-bold text-sm hover:bg-amber-200 transition-colors shadow-sm"
              >
              ...
              <Link
                to="/profile"
                className="flex items-center gap-2 bg-slate-100 text-slate-700 p-2 pr-4 rounded-full font-bold text-sm hover:bg-slate-200 transition-colors shadow-sm"
              >
            ...
            <div className="md:hidden flex items-center gap-4">
              <Link to="/profile" className="flex items-center justify-center bg-amber-100 text-amber-700 h-10 w-10 rounded-full shadow-sm">
          ...
          {isMenuOpen && (
            ...
            >
              <div className="px-4 pt-4 pb-6 space-y-2">
                ...
                <Link
                  to="/profile"
                  className="mt-4 flex items-center justify-center gap-2 w-full bg-slate-100 text-slate-700 px-4 py-3 rounded-2xl font-bold text-lg hover:bg-slate-200 transition-colors"
                  onClick={() => setIsMenuOpen(false)}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex space-x-4">
              <Link to="/locations" className="text-slate-400 hover:text-rose-400 transition-colors font-bold">尋找捐血車</Link>
              <Link to="/rewards" className="text-slate-400 hover:text-rose-400 transition-colors font-bold">點數兌換</Link>
            </div>
          </div>
